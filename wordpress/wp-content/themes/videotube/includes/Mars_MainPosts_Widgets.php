	          	...
	          	<?php endif;?>
                    ...
                    <?php if( $widget_column == 3 ):?>
	                    	...
	                    	<div class="row">
			                     <div class="carousel-inner">
			                       	...
			                       	if( $wp_query->have_posts() ) : 
				                       	...
				                       	$the_title = mars_seo_limit_leng_titlewords( get_the_title(), $this->title_length );
				                       	$i++;
				                       	?>
				                       	<?php if( $i == 1 ):?>
				                       		<div class="item active">
				                       	<?php endif;?>	
				                       		<div id="post-main-<?php the_ID();?>" <?php post_class('col-sm-4 col-xs-6');?>>
												<?php 
												...
												<div class="post-header">
		                                            <h3><a title="<?php the_title();?>" href="<?php the_permalink();?>"><?php print $the_title;?></a></h3>
                   	...
                   	<?php elseif( $widget_column == 2 ):?>
                   		...
                   		<?php $the_title = mars_seo_limit_leng_titlewords( get_the_title(), $this->title_length );?>                	
						<div id="post-main-<?php the_ID();?>" <?php post_class('col-sm-6 item');?>>
							<?php 
								if(has_post_thumbnail()){
	                       	...
	                       	if( $wp_query->have_posts() ) : 
		                       	...
		                       	<?php endif;?>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7 item list post post-<?php print get_the_ID();?>">
                                        	<div class="post-header">
                                            	<h3><a title="<?php the_title();?>" href="<?php the_permalink();?>"><?php print $the_title;?></a></h3>
												<span class="post-meta">
													<i class="fa fa-clock-o"></i> <?php print get_the_date('F j ,Y');?>
