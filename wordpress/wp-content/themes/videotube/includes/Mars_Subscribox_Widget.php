...
class Mars_Subscribox_Widget_Class extends WP_Widget{
	function Mars_Subscribox_Widget_Class(){
		$widget_ops = array( 'classname' => 'mars-subscribox-widget', 'description' => __('VT Social Subscribe Box', 'wpo') );
		
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'mars-subscribox-widget' );
		
		$this->WP_Widget( 'mars-subscribox-widget', __('VT Social Subscribe Box', 'wpo'), $widget_ops, $control_ops );		
	}
