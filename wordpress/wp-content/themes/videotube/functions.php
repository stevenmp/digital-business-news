...
if( !function_exists('mars_enqueue_scripts') ){
	function mars_enqueue_scripts() {
		...
		wp_enqueue_script('mars-bootstrap.min.js', MARS_THEME_URI . '/assets/js/bootstrap.min.js', array(), '', true);
		...
		wp_enqueue_style('mars-bootstrap.min.css', MARS_THEME_URI . '/assets/css/bootstrap.min.css');
...
/**
register_sidebar( $args = array(
		'name'          => __( 'Header Sidebar', 'mars' ),
		'id'            => 'mars-header-sidebar',
		'description'   => __('Display the Widgets in Header, if not set, the search form is displayed by default.','mars'),
		'before_widget' => null,
		'after_widget'  => null,
		'before_title'  => null,
		'after_title'   => null,
